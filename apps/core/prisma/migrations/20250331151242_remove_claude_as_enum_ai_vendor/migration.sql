/*
  ...
  - The values [CLAUDE] on the enum `AiVendor` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AiVendor_new" AS ENUM ('OPENAI', 'GEMINI', 'ANTHROPIC');
